...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="flex flex-col flex-1 min-h-0 bg-background border-r border-border/40">
        {/* Logo Section */}
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute -right-4 top-7 h-8 w-8 rounded-full border shadow-md bg-background hover:bg-accent"
